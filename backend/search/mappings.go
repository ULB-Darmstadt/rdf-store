...
func createCollectionSchema() (fields []solr.Field) {
	...
	fields = append(fields, solr.Field{Name: "valueString", Type: "string", Indexed: true, Stored: false, DocValues: true, MultiValued: true})
	fields = append(fields, solr.Field{Name: "valueText", Type: "text_general", Indexed: true, Stored: false, MultiValued: true})
	fields = append(fields, solr.Field{Name: "valueNumber", Type: "pdouble", Indexed: true, Stored: false, DocValues: true, MultiValued: true})
	fields = append(fields, solr.Field{Name: "valueDate", Type: "pdate", Indexed: true, Stored: false, DocValues: true, MultiValued: true})
	fields = append(fields, solr.Field{Name: "valueBoolean", Type: "boolean", Indexed: true, Stored: false, DocValues: true, MultiValued: true})
	fields = append(fields, solr.Field{Name: "valueGeo", Type: "location_rpt", Indexed: true, Stored: false, MultiValued: true})
	fields = append(fields, solr.Field{Name: "datatype", Type: "string", Indexed: true, Stored: false, DocValues: true, MultiValued: true})
	fields = append(fields, solr.Field{Name: "language", Type: "string", Indexed: true, Stored: false, DocValues: true, MultiValued: true})
	return fields
}
