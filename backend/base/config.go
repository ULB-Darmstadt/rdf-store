...
var MPSEndpoint = EnvVar("MPS_ENDPOINT", "https://aims-backend.tools.coscine.dev/AIMS/application-profiles")
var MPSUrl = fmt.Sprintf("%s/?includeDefinition=true&%s", MPSEndpoint, MPSQuery)
