...
var FOAF_FIRST_NAME = rdf2go.NewResource(fmt.Sprintf(prefixFOAF, "firstName"))
var FOAF_LAST_NAME = rdf2go.NewResource(fmt.Sprintf(prefixFOAF, "lastName"))
...
var DCTERMS_CREATED = rdf2go.NewResource(fmt.Sprintf(prefixDCTerms, "created"))
...
var SHACL_QUALIFIED_VALUE_SHAPE = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "qualifiedValueShape"))
var SHACL_QUALIFIED_MIN_COUNT = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "qualifiedMinCount"))
var SHACL_MIN_COUNT = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "minCount"))
var SHACL_MAX_COUNT = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "maxCount"))
var SHACL_IN = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "in"))
var SHACL_HAS_VALUE = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "hasValue"))
var SHACL_OR = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "or"))
var SHACL_XONE = rdf2go.NewResource(fmt.Sprintf(prefixSHACL, "xone"))
